namespace PaySys.EF.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CurrentContract_ContractMasterId = c.Int(),
                    })
                .PrimaryKey(t => t.EmployeeId)
                .ForeignKey("dbo.ContractMasters", t => t.CurrentContract_ContractMasterId)
                .Index(t => t.CurrentContract_ContractMasterId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Employees", "CurrentContract_ContractMasterId", "dbo.ContractMasters");
            ...
            DropIndex("dbo.Employees", new[] { "CurrentContract_ContractMasterId" });
